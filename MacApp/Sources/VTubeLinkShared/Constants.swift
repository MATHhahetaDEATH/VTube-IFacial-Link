...
public struct Constants {
    public static let blendshapeNames = [
    ...
    public static let customParams = [
    ...
    public static let facePositionXRatio: Float = 100
    public static let facePositionYRatio: Float = 100
    public static let facePositionZRatio: Float = 50
    public static let faceAngleXRatio: Float = 1
    public static let faceAngleYRatio: Float = 1
    public static let faceAngleZRatio: Float = 1
    
    public static let mouthSmileRatio: Float = 2
    public static let mouseOpenRatio: Float = 1.2
    public static let browsRatio: Float = 2
    public static let tongueOutRatio: Float = 0.4
    
    public static let eyeOpenRatio: Float = 1.25
    public static let eyeRotationRatio: Float = 1.5
    
    public static let cheekPuffRatio: Float = 2
    public static let faceAngryRatio: Float = 0.3
    
    public static let browLeftYRatio: Float = 2
    public static let browRightYRatio: Float = 2
    public static let mouthXRatio: Float = 2
}
